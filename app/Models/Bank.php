...
class Bank extends Model
{
	...
	public static function createDefaultQueries()
	{
		$json = [[
			"code"=>"001",
		...
		[
			"code"=>"241",
			"name"=>"Banco ClÃ¡ssico"

		],
		
		[
			"code"=>"243",
			"name"=>"Banco Stock MÃ¡xima"
		...
		[
			"code"=>"248",
			"name"=>"Banco Boavista InteratlÃ¢ntico"
		...
		[
			"code"=>"394",
			"name"=>"Banco Mercantil de CrÃ©dito"
		...
		[
			"code"=>"494",
			"name"=>"Banco la RepÃºblica Oriental del Uruguay"
		...
		[
			"code"=>"739",
			"name"=>"Banco GalvÃ£o de NegÃ³cios"
