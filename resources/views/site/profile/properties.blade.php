...
@section('body_content')
    ...
    <div id="wrapper">
        ...
        <div id="content">
            <div class="filter">
                <h1 class="osLight" style="color: #00A7ED; font-weight: bold; font-size: 1.5em;">Meus Imóveis</h1>
                ...
                <div class="row">
                    @foreach($_SELF_TEMPLATE_['Properties'] as $property)
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="margin-bottom: 20px;">
                            ...
                            <a href="{{route('property.change_cover',$property->id)}}" class="btn btn-warning pull-right btn-xs"
                                style="border-radius: 0px; margin-left: 10px;"
                            >
                                <i class="fa fa-image"></i>
                                Capa
                            </a>

                            <a href="{{route('property.edit',$property->id)}}" class="btn btn-success pull-right btn-xs" style="border-radius: 0px; margin-left: 10px;"><i
                                        class="fa fa-edit"></i> Editar</a>
                            <a href="{{route('scheduler',$property->id)}}" class="btn btn-info pull-right btn-xs" style="border-radius: 0px;"><i
                                        class="fa fa-calendar"></i> Agenda</a>
                        </div>
                    @endforeach
                </div>
                {{--<ul class="pagination">--}}
